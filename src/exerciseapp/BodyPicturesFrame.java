...
public class BodyPicturesFrame extends javax.swing.JFrame {

    DataHandler dh;
    List<String> pictures;
    int viewing = 0;

    public BodyPicturesFrame(DataHandler cdh) {
        initComponents();
        ...
        List<String> picturesDays = dh.getBodyPicturesDays();
    ...
    private void dayCmbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dayCmbActionPerformed
        pictures = dh.getBodyPicturesForDay((String) dayCmb.getSelectedItem());
        viewing = 0;
        if (pictures.size() > 0) {
            pictureLbl.setIcon(new ImageIcon(new ImageIcon(pictures.get(0)).getImage().getScaledInstance(350, 350, java.awt.Image.SCALE_SMOOTH)));
        }
